            ...
            <div class="mx-auto __max-w-360">
                ...
                <form class="needs-validation mt-2" autocomplete="off" action="{{route('customer.auth.login')}}"
                    ...
                    <div class="form-group">
                        ...
                        <label>
                            <input type="checkbox" required id="termsCheckbox" name="terms"> I accept the <a href="{{ route('privacy-policy') }}" target="_blank">Privacy Policy</a> & <a href="{{ route('terms') }}" target="_blank">Terms and Conditions</a>
                        </label>
                    </div>
