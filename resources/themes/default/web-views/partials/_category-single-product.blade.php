    ...
    <div class="overflow-hidden position-relative">
        ...
        <div class="single-product-details">
            ...
            <div class="">
                ...
                <span class="badge badge-pill badge-light border border-1" style="border-color:#ff0000 !important" ><img src="{{ asset('public/images/prescription.png') }}" style="width: 20px;" /></span>

                @endisset

                @if($product?->cold_chain)
                <span class="badge badge-pill badge-light border border-1" data-toggle="tooltip" data-placement="top" title="Medicines Packed And Stored At The Optimum Temperature" style="border-color:#69b3fe !important" ><img src="{{ asset('public/images/coldchain.png') }}" style="width: 20px;" /></span>
                @endisset

                @if($product?->pap_description)
                <span class="badge badge-pill badge-light border border-1" style="border-color:#1caf88 !important" ><img src="{{ asset('public/images/pap_scheme.png') }}" style="width: 20px;" /></span>
                @endisset
            </div>
