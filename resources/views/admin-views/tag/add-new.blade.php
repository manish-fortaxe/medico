            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.tag.add-new') }}" method="post" enctype="multipart/form-data" class="brand-setup-form">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="tag" class="form-control" id="name" value=""
